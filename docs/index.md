...
syllabus, and all 9 graded assignments.
...
!!! tip "Honest scope"
    This is **unofficial**, built by students, matching the **T2-2026 syllabus**. The
    real rubric is private — everything here is our best reading of four real papers
    and the professor's revision sessions. The syllabus changes every term: next term's
    students get the structure, and re-verify the content.
