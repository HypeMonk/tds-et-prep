...
Pick your countdown · every plan uses the same priority order · [frequency table](../pyqs/index.md#the-priority-list-how-often-each-topic-is-asked) drives everything
...
### Day 1 — The game + W2 + first paper
- [Exam pattern](../exam/exam-pattern.md) + [LLM grading guide](../exam/llm-grading-guide.md) — 12 min
- [Week 2](../weeks/week-2.md) — 25 min
- [T1-2026 AN](../pyqs/t1-2026-an.md) — attempt + review

### Day 2 — W1 + two papers
- [Week 1](../weeks/week-1.md) — 20 min
- [T1-2026 FN](../pyqs/t1-2026-fn.md) + [T3-2025 FN](../pyqs/t3-2025-fn.md) — attempt + review

### Day 3 — W3 + old paper + new topics start
- [Week 3](../weeks/week-3.md) — 20 min
- [T3-2025 AN](../pyqs/t3-2025-an.md) — attempt + review
- [Week 4 — RAG](../weeks/week-4.md) — 18 min

### Day 4 — Remaining new weeks + practice
- [Week 5](../weeks/week-5.md) + [Week 7](../weeks/week-7.md) + [Week 8](../weeks/week-8.md) — 53 min
- [Practice: new topics](../practice/new-topics.md) — 18 questions
...
*🔥🔥 topics + PYQs + short notes + one mock.*

### Day 1 — The game + hottest week + first paper
- [Exam pattern](../exam/exam-pattern.md) + [LLM grading guide](../exam/llm-grading-guide.md) — 12 min
- [Week 2](../weeks/week-2.md) — 25 min
- [Week 1](../weeks/week-1.md) — 20 min
- [T1-2026 AN](../pyqs/t1-2026-an.md) — attempt + review

### Day 2 — More papers + LLM week
- [T1-2026 FN](../pyqs/t1-2026-fn.md) — attempt + review
- [T3-2025 FN](../pyqs/t3-2025-fn.md) — attempt + review
- [Week 3](../weeks/week-3.md) — 20 min

### Day 3 — New topics + last paper
- [Week 4 — RAG](../weeks/week-4.md) + [Week 5 — Agents](../weeks/week-5.md) — 36 min
- [Week 7 — Security](../weeks/week-7.md) + [Week 8 — ML](../weeks/week-8.md) — 35 min
- [T3-2025 AN](../pyqs/t3-2025-an.md) — the RAG block especially
...
### Day 1 — The game + W2 + W1 + first paper
- [Exam pattern](../exam/exam-pattern.md) + [LLM grading guide](../exam/llm-grading-guide.md) — 12 min
- [Week 2](../weeks/week-2.md) — 25 min
- [Week 1](../weeks/week-1.md) — 20 min
- [T1-2026 AN](../pyqs/t1-2026-an.md) — attempt the 🔥 questions at minimum

### Day 2 — More papers + all new topics
- [T1-2026 FN](../pyqs/t1-2026-fn.md) — attempt + review
- [T3-2025 FN](../pyqs/t3-2025-fn.md) — attempt + review
- [Week 4 — RAG](../weeks/week-4.md) + [Week 7 — Security](../weeks/week-7.md) — 38 min
- [Practice: new topics](../practice/new-topics.md) — attempt the RAG + security questions
...
*The guides + short notes + the two hottest papers + GA0.*

### Day 1 — The game + short notes + first paper
- [Exam pattern](../exam/exam-pattern.md) + [LLM grading guide](../exam/llm-grading-guide.md) — 12 min
- [Short notes (all 6 categories)](../revise/index.md) — 40 min
...
### Morning (2 hours)
- [Exam pattern](../exam/exam-pattern.md) — 6 min
- [LLM grading guide](../exam/llm-grading-guide.md) — 6 min
- [Short notes: Web & APIs](../topics/web-apis.md) — 6 min
- [Short notes: Docker & deployment](../topics/docker-deployment.md) — 7 min
- [Short notes: LLMs & prompting](../topics/llm-prompting.md) — 6 min

### Afternoon (2 hours)
- [Short notes: RAG & agents](../topics/rag-agents.md) — 7 min
- [Short notes: Data & ML](../topics/data-ml.md) — 7 min
- [Short notes: Git, security & practices](../topics/git-security.md) — 6 min
...
## Last minute · the final hour

*The coloured boxes only. Nothing else.*
